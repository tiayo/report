...
class Dispatcher {
    ...
    static public function dispatch() {
        ...
        if(empty($_SERVER['PATH_INFO'])) {
            ...
            // =====修改 支持 index.php/addon/Vote/Vote/lists 这样的插件短地址
            ...
            }elseif(substr ( $info, 0, 7 ) == 'plugin/' && C ( 'URL_ROUTER_ON' ) && isset ( $re ['Addons/execute/:_addons/:_controller/:_action'] )){
                $info = str_replace ( 'plugin/', 'Manage/Plugins/execute/', $info );
            }
