...
function T($template = '', $layer = '') {
    ...
    if (defined ( '_PLUGINS' ) && false === strpos ( $template, '://' )) {
        if (empty ( $template )) {
            $file_path = SITE_PATH . '/Plugins/' . _PLUGINS . '/View/default/' . _CONTROLLER . '/' . _ACTION . $temp_fix;
        } elseif (false === strpos ( $template, '/' )) {
            $file_path = SITE_PATH . '/Plugins/' . _PLUGINS . '/View/default/' . _CONTROLLER . '/' . $template . $temp_fix;
        } else {
            $file_path = SITE_PATH . '/Plugins/' . _PLUGINS . '/View/default/' . $template . $temp_fix;
        }
        if (file_exists ( $file_path )) {
            return $file_path;
        } elseif (defined ( 'CUSTOM_TEMPLATE_PATH' ) && file_exists ( CUSTOM_TEMPLATE_PATH . $template . $temp_fix )) {
...
function D($name = '', $layer = '') {
    ...
    if (defined ( '_PLUGINS' )) {
        $class_addon = parse_res_name ( 'Plugins://' . _PLUGINS . '/' . $name, $layer );
    }
...
function U($url = '', $vars = '', $suffix = true, $domain = true) {
    ...
    if(defined('_PLUGINS')){
        if (isset ( $_GET ['_addons'] ) && strpos ( $info ['path'], '/' ) === false) {
            ...
            $info ['path'] = 'manage/plugins/execute';
        }
    }
    if(defined('_ADDONS')){
        if (isset ( $_GET ['_addons'] ) && strpos ( $info ['path'], '/' ) === false) {
    ...
    if (C ( 'URL_ROUTER_ON' ) && isset ( $re ['Plugins/execute/:_addons/:_controller/:_action'] )) {
        $url = str_ireplace ( array (
                'manage/plugins/execute',
                '_addons/',
                '_controller/',
                '_action/' 
        ), array (
