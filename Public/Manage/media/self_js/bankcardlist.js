bankCard = {
	...
	buildQueryParams : function(){
		...
		this.pageParams.pagesize = $.trim($('[name=pagesize]').val());
	},
	buildHtml : function(data){
		...
		html +='<thead class="flip-content">'+
			...
			'</tr>'+
				...
				html+='<tr data-aid="'+data[i].aid+'" data-id="'+data[i].id+'" data-type="'+data[i].type+'" data-bank="'+data[i].bank+'" data-bankaccount="'+data[i].bankaccount+'" data-swift="'+data[i].swift+'" data-zheng="'+data[i].cardpositiveurl+'" data-fan="'+data[i].cardnegativeurl+'" data-code="'+data[i].bank_code+'">'+
				'<td data-code='+data[i].bank_code+'   >'+data[i].bank_name+'</td>'+
				'<td>'+data[i].bankaccount+'</td>'+
				'<td>'+data[i].swift+'</td>'+
				'<td><button type="button" class="btn mini showcard" data-url="'+rooturl+data[i].cardpositiveurl+'">正面</button><button type="button" class="btn mini showcard" data-url="'+rooturl+data[i].cardnegativeurl+'">反面</button></td>'+
				'<td><button type="button" class="btn yellow editCard">编辑</button><button type="button" class="btn red delCard" data-id='+data[i].id+'>删除</button></td>'+
				'</tr>';
			}
			html+='</tbody>'
		return html;
	...
	changeBankCard:function(){
		var self = this;
		$(document).on('click',".editCard,#add_new",function() {
			$this = $(this);
